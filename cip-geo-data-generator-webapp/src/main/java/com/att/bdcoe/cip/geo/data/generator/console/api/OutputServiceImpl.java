...
public class OutputServiceImpl implements OutputService{
    ...
    public List<Output> getLocation() { return metaDataService.getLocationOutputs();}

    @Override
    @RequestMapping(value="/nonlocation",method= RequestMethod.GET,headers="Accept=application/json"  )
    public List<Output> getNonLocation() { return metaDataService.getNonLocationOutputs();}
}
