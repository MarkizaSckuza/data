...
import com.att.bdcoe.cip.geo.data.core.gen.*;
...
import com.att.bdcoe.cip.geo.data.generator.model.MovingObjects;
	...
	private void generateDataForMovingObjects(
        ...
        try {
            if(configuration.getFactoryClassName()!=null?
                    (configuration.getFactoryClassName().trim().length()>0?
                    (!configuration.getFactoryClassName().equals("MapTrackBuilder")):false):false)
